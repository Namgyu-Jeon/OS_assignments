...
- Name: Assignment 01 public report
- Objective: 공개 링크 하나에서 과제 문서, 실제 실행 증거와 소스를 확인할 수 있게 합니다.
- Approved scope: 문서·Mermaid·스크린샷·최종 C++ 소스, 공개 저장소 게시와 검수
- Explicit exclusions: 실행 파일, ZIP, 빌드 캐시, 자격 증명
- Manual acceptance owner: 전남규

## Evidence

| Check | Last result | Evidence date |
|---|---|---|
